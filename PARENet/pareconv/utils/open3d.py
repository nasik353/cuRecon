...
def make_open3d_point_cloud(points, colors=None, normals=None):
    ...
    if normals is not None:
        pcd.point.normals = o3c.Tensor(normals, o3c.float32)
    return pcd
...
def draw_geometries(ref_pcd, src_pcd):
    o3d.visualization.draw_geometries([ref_pcd.to_legacy(), src_pcd.to_legacy()])
