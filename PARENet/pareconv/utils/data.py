...
def precompute_subsample(points, colors, lengths, num_stages, voxel_size, num_neighbors, subsample_ratio):
...
def registration_collate_fn_stack_mode(
    ...
    colors_list = collated_dict.pop('ref_colors') + collated_dict.pop('src_colors')
    ...
    if precompute_data:
        input_dict = precompute_subsample(points, colors, lengths, num_stages, voxel_size, num_neighbors, subsample_ratio)

        collated_dict.update(input_dict)
    else:
        collated_dict['points'] = points
        collated_dict['colors'] = colors
