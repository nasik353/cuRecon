...
class PARE_Net(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        colors = data_dict['colors'][0].detach()
        ...
        ref_colors = colors[:ref_length]
        src_colors = colors[ref_length:]
        ...
        output_dict['ref_colors'] = ref_colors
        output_dict['src_points'] = src_points
        output_dict['src_colors'] = src_colors
